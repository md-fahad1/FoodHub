...
//                 />
//               ) : (
//                 <MdAccountCircle className="text-secondary dark:text-dark-color text-[20px]" />
//               )}
          ...
          >
            ...
            >
              {profileImage ? (
                ...
                //   className="rounded-full object-cover"
                // />
                <CiUser className="text-secondary dark:text-dark-color text-[28px]" />
              ) : (
                <CiUser className="text-secondary dark:text-dark-color text-[20px]" />
              )}
              <div className="flex flex-col">
                <span className="text-secondary text-left text-sm hidden md:block font-medium dark:text-dark-color">
                  {currentUser?.name}
                </span>
                {/* <span className="text-secondary text-sm hidden md:block font-medium dark:text-dark-color">
                  {currentUser?.email}
                </span> */}
              </div>
